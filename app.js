...
window.onerror = function(msg, src, line, col, err) {
  var txt = 'JS ERROR line ' + line + ': ' + msg;
  document.body.innerHTML = '<div style="background:#1a0000;color:#ff6b6b;padding:20px;font-family:monospace;font-size:13px;white-space:pre-wrap">' + txt + (err ? '\n\nStack:\n' + err.stack : '') + '</div>';
...
console.log('[SCRIPT] 25% line ~1131 reached');
...
function buildTVChart(coin,tf){
  ...
  c.innerHTML='';
  if(IS_MOBILE){
console.log('[SCRIPT] 50% line ~2245 reached');
...
console.log('[SCRIPT] 75% line ~3380 reached');
